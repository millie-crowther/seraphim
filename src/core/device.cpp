...
static bool device_has_extension(VkPhysicalDevice phys_device, const char *extension) {
    ...
    vkEnumerateDeviceExtensionProperties(phys_device, nullptr,
...
static bool
has_adequate_queue_families(VkPhysicalDevice physical_device, VkSurfaceKHR surface) {
...
device_t::device_t(VkInstance instance, VkSurfaceKHR surface,
    ...
    std::set<uint32_t> unique_queue_families =
            {graphics_family, present_family, compute_family};
...
VkPhysicalDevice
device_t::select_physical_device(VkInstance instance,
                                 VkSurfaceKHR surface) const {
...
uint32_t device_memory_type(device_t *device,

...
mfloat_t *_vec2_multiply_mat2(mfloat_t * result, const mfloat_t * v0,
			      mfloat_t * m0)
{
	mfloat_t x = v0[0];
	mfloat_t y = v0[1];
...
mfloat_t *_vec2_clamp(mfloat_t * result, mfloat_t * v0, mfloat_t * v1,
		      mfloat_t * v2)
{
...
mfloat_t *_vec2_lerp(mfloat_t * result, mfloat_t * v0, mfloat_t * v1,
		     mfloat_t f)
{
...
mfloat_t *_vec2_bezier3(mfloat_t * result, mfloat_t * v0, mfloat_t * v1,
...
mfloat_t *_vec2_bezier4(mfloat_t * result, mfloat_t * v0, mfloat_t * v1,
...
mfloat_t *_vec3_subtract(mfloat_t * result, const mfloat_t * v0,
			 const mfloat_t * v1)
{
	result[0] = v0[0] - v1[0];
	result[1] = v0[1] - v1[1];
...
mfloat_t *_vec3_clamp(mfloat_t * result, mfloat_t * v0, mfloat_t * v1,
		      mfloat_t * v2)
{
...
mfloat_t *_vec3_cross(mfloat_t * result, const mfloat_t * v0,
		      const mfloat_t * v1)
{
...
mfloat_t *_vec3_rotate(mfloat_t * result, mfloat_t * v0, mfloat_t * ra,
		       mfloat_t f)
{
	mfloat_t cs;
	mfloat_t sn;
	...
	rz = ra[2];
	result[0] =
	    x * (cs + rx * rx * (1 - cs)) + y * (rx * ry * (1 - cs) - rz * sn) +
	    z * (rx * rz * (1 - cs) + ry * sn);
	result[1] =
...
mfloat_t *_vec3_lerp(mfloat_t * result, mfloat_t * v0, mfloat_t * v1,
		     mfloat_t f)
{
	result[0] = v0[0] + (v1[0] - v0[0]) * f;
	result[1] = v0[1] + (v1[1] - v0[1]) * f;
...
mfloat_t *_vec3_bezier3(mfloat_t * result, mfloat_t * v0, mfloat_t * v1,
			mfloat_t * v2, mfloat_t f)
{
...
mfloat_t *_vec3_bezier4(mfloat_t * result, mfloat_t * v0, mfloat_t * v1,
			mfloat_t * v2, mfloat_t * v3, mfloat_t f)
{
	mfloat_t tmp0[VEC3_SIZE];
	mfloat_t tmp1[VEC3_SIZE];
...
mfloat_t *_vec4_new(mfloat_t * result, mfloat_t x, mfloat_t y, mfloat_t z,
		    mfloat_t w)
{
	result[0] = x;
	result[1] = y;
...
mfloat_t *_vec4_clamp(mfloat_t * result, mfloat_t * v0, mfloat_t * v1,
		      mfloat_t * v2)
{
...
mfloat_t *_vec4_lerp(mfloat_t * result, mfloat_t * v0, mfloat_t * v1,
		     mfloat_t f)
{
	result[0] = v0[0] + (v1[0] - v0[0]) * f;
	result[1] = v0[1] + (v1[1] - v0[1]) * f;
...
mfloat_t *_quat_from_vec3(mfloat_t * result, const mfloat_t * v0,
			  const mfloat_t * v1)
{
	mfloat_t cross[VEC3_SIZE];
...
mfloat_t *_quat_lerp(mfloat_t * result, mfloat_t * q0, mfloat_t * q1,
		     mfloat_t f)
{
...
mfloat_t *_quat_slerp(mfloat_t * result, mfloat_t * q0, mfloat_t * q1,
		      mfloat_t f)
{
...
mfloat_t *_mat2_new(mfloat_t * result, mfloat_t m11, mfloat_t m12, mfloat_t m21,
		    mfloat_t m22)
{
	result[0] = m11;
	result[1] = m21;
...
mfloat_t *_mat2_lerp(mfloat_t * result, mfloat_t * m0, mfloat_t * m1,
		     mfloat_t f)
{
...
mfloat_t *_mat3_new(mfloat_t * result, mfloat_t m11, mfloat_t m12, mfloat_t m13,
...
mfloat_t *_mat3_scale(mfloat_t * result, const mfloat_t * m0,
		      const mfloat_t * v0)
{
	result[0] = m0[0] * v0[0];
	result[4] = m0[4] * v0[1];
...
mfloat_t *_mat3_lerp(mfloat_t * result, mfloat_t * m0, mfloat_t * m1,
		     mfloat_t f)
{
	result[0] = m0[0] + (m1[0] - m0[0]) * f;
	result[1] = m0[1] + (m1[1] - m0[1]) * f;
...
mfloat_t *_mat4_new(mfloat_t * result, mfloat_t m11, mfloat_t m12, mfloat_t m13,
...
mfloat_t *_mat4_lerp(mfloat_t * result, mfloat_t * m0, mfloat_t * m1,
		     mfloat_t f)
{
	result[0] = m0[0] + (m1[0] - m0[0]) * f;
	result[1] = m0[1] + (m1[1] - m0[1]) * f;
...
mfloat_t *_mat4_look_at(mfloat_t * result, mfloat_t * position,
...
{
	return (vec2i *) _vec2i_subtract((mint_t *) result, (mint_t *) v0,
					 (mint_t *) v1);
}
...
{
	return (vec2i *) _vec2i_multiply((mint_t *) result, (mint_t *) v0,
					 (mint_t *) v1);
}
...
{
	return (vec2i *) _vec2i_divide((mint_t *) result, (mint_t *) v0,
				       (mint_t *) v1);
}
...
{
	return (vec2i *) _vec2i_snap((mint_t *) result, (mint_t *) v0,
				     (mint_t *) v1);
}
...
{
	return (vec2i *) _vec2i_max((mint_t *) result, (mint_t *) v0,
				    (mint_t *) v1);
}

vec2i *vec2i_min(vec2i * result, vec2i * v0, vec2i * v1)
{
	return (vec2i *) _vec2i_min((mint_t *) result, (mint_t *) v0,
				    (mint_t *) v1);
}

vec2i *vec2i_clamp(vec2i * result, vec2i * v0, vec2i * v1, vec2i * v2)
{
	return (vec2i *) _vec2i_clamp((mint_t *) result, (mint_t *) v0,
				      (mint_t *) v1, (mint_t *) v2);
}
...
{
	return (vec3i *) _vec3i_subtract((mint_t *) result, (mint_t *) v0,
					 (mint_t *) v1);
}
...
{
	return (vec3i *) _vec3i_multiply((mint_t *) result, (mint_t *) v0,
					 (mint_t *) v1);
}
...
{
	return (vec3i *) _vec3i_divide((mint_t *) result, (mint_t *) v0,
				       (mint_t *) v1);
}
...
{
	return (vec3i *) _vec3i_snap((mint_t *) result, (mint_t *) v0,
				     (mint_t *) v1);
}
...
{
	return (vec3i *) _vec3i_cross((mint_t *) result, (mint_t *) v0,
				      (mint_t *) v1);
}
...
{
	return (vec3i *) _vec3i_max((mint_t *) result, (mint_t *) v0,
				    (mint_t *) v1);
}

vec3i *vec3i_min(vec3i * result, vec3i * v0, vec3i * v1)
{
	return (vec3i *) _vec3i_min((mint_t *) result, (mint_t *) v0,
				    (mint_t *) v1);
}

vec3i *vec3i_clamp(vec3i * result, vec3i * v0, vec3i * v1, vec3i * v2)
{
	return (vec3i *) _vec3i_clamp((mint_t *) result, (mint_t *) v0,
				      (mint_t *) v1, (mint_t *) v2);
}
...
{
	return (vec4i *) _vec4i_add((mint_t *) result, (mint_t *) v0,
				    (mint_t *) v1);
}
...
{
	return (vec4i *) _vec4i_subtract((mint_t *) result, (mint_t *) v0,
					 (mint_t *) v1);
}
...
{
	return (vec4i *) _vec4i_multiply((mint_t *) result, (mint_t *) v0,
					 (mint_t *) v1);
}
...
{
	return (vec4i *) _vec4i_divide((mint_t *) result, (mint_t *) v0,
				       (mint_t *) v1);
}
...
{
	return (vec4i *) _vec4i_snap((mint_t *) result, (mint_t *) v0,
				     (mint_t *) v1);
}
...
{
	return (vec4i *) _vec4i_max((mint_t *) result, (mint_t *) v0,
				    (mint_t *) v1);
}

vec4i *vec4i_min(vec4i * result, vec4i * v0, vec4i * v1)
{
	return (vec4i *) _vec4i_min((mint_t *) result, (mint_t *) v0,
				    (mint_t *) v1);
}

vec4i *vec4i_clamp(vec4i * result, vec4i * v0, vec4i * v1, vec4i * v2)
{
	return (vec4i *) _vec4i_clamp((mint_t *) result, (mint_t *) v0,
				      (mint_t *) v1, (mint_t *) v2);
}
...
{
	return (vec2 *) _vec2_add((mfloat_t *) result, (mfloat_t *) v0,
				  (mfloat_t *) v1);
}
...
{
	return (vec2 *) _vec2_subtract_f((mfloat_t *) result, (mfloat_t *) v0,
					 f);
}
...
{
	return (vec2 *) _vec2_multiply_f((mfloat_t *) result, (mfloat_t *) v0,
					 f);
}

vec2 *vec2_multiply_mat2(vec2 * result, vec2 * v0, mat2 * m0)
{
	return (vec2 *) _vec2_multiply_mat2((mfloat_t *) result,
					    (mfloat_t *) v0, (mfloat_t *) m0);
}

vec2 *vec2_divide(vec2 * result, vec2 * v0, vec2 * v1)
{
	return (vec2 *) _vec2_divide((mfloat_t *) result, (mfloat_t *) v0,
				     (mfloat_t *) v1);
}
...
{
	return (vec2 *) _vec2_snap((mfloat_t *) result, (mfloat_t *) v0,
				   (mfloat_t *) v1);
}
...
{
	return (vec2 *) _vec2_max((mfloat_t *) result, (mfloat_t *) v0,
				  (mfloat_t *) v1);
}

vec2 *vec2_min(vec2 * result, vec2 * v0, vec2 * v1)
{
	return (vec2 *) _vec2_min((mfloat_t *) result, (mfloat_t *) v0,
				  (mfloat_t *) v1);
}

vec2 *vec2_clamp(vec2 * result, vec2 * v0, vec2 * v1, vec2 * v2)
{
	return (vec2 *) _vec2_clamp((mfloat_t *) result, (mfloat_t *) v0,
...
{
	return (vec2 *) _vec2_project((mfloat_t *) result, (mfloat_t *) v0,
				      (mfloat_t *) v1);
}
...
{
	return (vec2 *) _vec2_lerp((mfloat_t *) result, (mfloat_t *) v0,
				   (mfloat_t *) v1, f);
}

vec2 *vec2_bezier3(vec2 * result, vec2 * v0, vec2 * v1, vec2 * v2, mfloat_t f)
{
	return (vec2 *) _vec2_bezier3((mfloat_t *) result, (mfloat_t *) v0,
...
vec2 *vec2_bezier4(vec2 * result, vec2 * v0, vec2 * v1, vec2 * v2, vec2 * v3,
		   mfloat_t f)
{
	return (vec2 *) _vec2_bezier4((mfloat_t *) result, (mfloat_t *) v0,
				      (mfloat_t *) v1, (mfloat_t *) v2,
				      (mfloat_t *) v3, f);
}
...
{
	return (vec3 *) _vec3_subtract((mfloat_t *) result,
				       (const mfloat_t *)v0,
				       (const mfloat_t *)v1);
}
...
{
	return (vec3 *) _vec3_subtract_f((mfloat_t *) result, (mfloat_t *) v0,
					 f);
}
...
{
	return (vec3 *) _vec3_multiply_mat3((mfloat_t *) result,
					    (const mfloat_t *)v0,
					    (const mfloat_t *)m0);
}
...
{
	return (vec3 *) _vec3_divide((mfloat_t *) result, (mfloat_t *) v0,
				     (mfloat_t *) v1);
}
...
{
	return (vec3 *) _vec3_snap((mfloat_t *) result, (mfloat_t *) v0,
				   (mfloat_t *) v1);
}
...
{
	return (vec3 *) _vec3_max((mfloat_t *) result, (mfloat_t *) v0,
				  (mfloat_t *) v1);
}

vec3 *vec3_min(vec3 * result, vec3 * v0, vec3 * v1)
{
	return (vec3 *) _vec3_min((mfloat_t *) result, (mfloat_t *) v0,
				  (mfloat_t *) v1);
}

vec3 *vec3_clamp(vec3 * result, vec3 * v0, vec3 * v1, vec3 * v2)
{
	return (vec3 *) _vec3_clamp((mfloat_t *) result, (mfloat_t *) v0,
				    (mfloat_t *) v1, (mfloat_t *) v2);
}
...
{
	return (vec3 *) _vec3_normalize((mfloat_t *) result,
					(const mfloat_t *)v0);
}
...
{
	return (vec3 *) _vec3_project((mfloat_t *) result, (mfloat_t *) v0,
				      (mfloat_t *) v1);
}
...
{
	return (vec3 *) _vec3_lerp((mfloat_t *) result, (mfloat_t *) v0,
				   (mfloat_t *) ra, f);
}
...
{
	return (vec3 *) _vec3_bezier3((mfloat_t *) result, (mfloat_t *) v0,
				      (mfloat_t *) v1, (mfloat_t *) v2, f);
}
...
vec3 *vec3_bezier4(vec3 * result, vec3 * v0, vec3 * v1, vec3 * v2, vec3 * v3,
		   mfloat_t f)
{
	return (vec3 *) _vec3_bezier4((mfloat_t *) result, (mfloat_t *) v0,
				      (mfloat_t *) v1, (mfloat_t *) v2,
				      (mfloat_t *) v3, f);
}
...
{
	return (vec4 *) _vec4_add((mfloat_t *) result, (mfloat_t *) v0,
				  (mfloat_t *) v1);
}
...
{
	return (vec4 *) _vec4_subtract_f((mfloat_t *) result, (mfloat_t *) v0,
					 f);
}
...
{
	return (vec4 *) _vec4_multiply_mat4((mfloat_t *) result,
					    (mfloat_t *) v0, (mfloat_t *) m0);
}

vec4 *vec4_divide(vec4 * result, vec4 * v0, vec4 * v1)
{
	return (vec4 *) _vec4_divide((mfloat_t *) result, (mfloat_t *) v0,
				     (mfloat_t *) v1);
}
...
{
	return (vec4 *) _vec4_snap((mfloat_t *) result, (mfloat_t *) v0,
				   (mfloat_t *) v1);
}
...
{
	return (vec4 *) _vec4_max((mfloat_t *) result, (mfloat_t *) v0,
				  (mfloat_t *) v1);
}

vec4 *vec4_min(vec4 * result, vec4 * v0, vec4 * v1)
{
	return (vec4 *) _vec4_min((mfloat_t *) result, (mfloat_t *) v0,
				  (mfloat_t *) v1);
}

vec4 *vec4_clamp(vec4 * result, vec4 * v0, vec4 * v1, vec4 * v2)
{
	return (vec4 *) _vec4_clamp((mfloat_t *) result, (mfloat_t *) v0,
				    (mfloat_t *) v1, (mfloat_t *) v2);
}
...
{
	return (vec4 *) _vec4_lerp((mfloat_t *) result, (mfloat_t *) v0,
				   (mfloat_t *) v1, f);
}
...
{
	result->v[0] =
	    q0->v[3] * q1->v[0] + q0->v[0] * q1->v[3] + q0->v[1] * q1->v[2] -
	    q0->v[2] * q1->v[1];
	result->v[1] =
	    q0->v[3] * q1->v[1] + q0->v[1] * q1->v[3] + q0->v[2] * q1->v[0] -
	    q0->v[0] * q1->v[2];
	result->v[2] =
	    q0->v[3] * q1->v[2] + q0->v[2] * q1->v[3] + q0->v[0] * q1->v[1] -
	    q0->v[1] * q1->v[0];
	result->v[3] =
	    q0->v[3] * q1->v[3] - q0->v[0] * q1->v[0] - q0->v[1] * q1->v[1] -
	    q0->v[2] * q1->v[2];
...
{
	return (quat *) _quat_multiply_f((mfloat_t *) result, (mfloat_t *) q0,
					 f);
}

quat *quat_divide(quat * result, quat * q0, quat * q1)
{
	return (quat *) _quat_divide((mfloat_t *) result, (mfloat_t *) q0,
				     (mfloat_t *) q1);
}
...
{
	return (quat *) _quat_power((mfloat_t *) result, (mfloat_t *) q0,
				    exponent);
}
...
quat *quat_from_axis_angle(quat * result, const vec3 * v0, mfloat_t angle)
{
	...
	return (quat *) _quat_from_axis_angle((mfloat_t *) result,
					      (const mfloat_t *)&vn, angle);
}

quat *quat_from_vec3(quat * result, const vec3 * v0, const vec3 * v1)
{
	return (quat *) _quat_from_vec3((mfloat_t *) result,
					(const mfloat_t *)v0,
					(const mfloat_t *)v1);
}
...
{
	return (quat *) _quat_lerp((mfloat_t *) result, (mfloat_t *) q0,
				   (mfloat_t *) q1, f);
}

quat *quat_slerp(quat * result, quat * q0, quat * q1, mfloat_t f)
{
	return (quat *) _quat_slerp((mfloat_t *) result, (mfloat_t *) q0,
				    (mfloat_t *) q1, f);
}
...
{
	return (mat2 *) _mat2_scale((mfloat_t *) result, (mfloat_t *) m0,
				    (mfloat_t *) v0);
}
...
{
	return (mat2 *) _mat2_lerp((mfloat_t *) result, (mfloat_t *) m0,
				   (mfloat_t *) m1, f);
}
...
mat3 *mat3_new(mat3 * result, mfloat_t m11, mfloat_t m12, mfloat_t m13,
	       ...
	       mfloat_t m32, mfloat_t m33)
{
	return (mat3 *) _mat3_new((mfloat_t *) result, m11, m12, m13, m21, m22,
				  m23, m31, m32, m33);
}
...
{
	return (mat3 *) _mat3_rotation_axis((mfloat_t *) result,
					    (mfloat_t *) v0, f);
}

mat3 *mat3_rotation_quat(mat3 * result, const quat * q0)
{
	return (mat3 *) _mat3_rotation_quat((mfloat_t *) result,
					    (const mfloat_t *)q0);
}

mat3 *mat3_lerp(mat3 * result, mat3 * m0, mat3 * m1, mfloat_t f)
{
	return (mat3 *) _mat3_lerp((mfloat_t *) result, (mfloat_t *) m0,
				   (mfloat_t *) m1, f);
}
...
mat4 *mat4_new(mat4 * result, mfloat_t m11, mfloat_t m12, mfloat_t m13,
	       ...
	       mfloat_t m44)
{
	return (mat4 *) _mat4_new((mfloat_t *) result, m11, m12, m13, m14, m21,
...
{
	return (mat4 *) _mat4_rotation_axis((mfloat_t *) result,
					    (mfloat_t *) v0, f);
}

mat4 *mat4_rotation_quat(mat4 * result, const quat * q0)
{
	return (mat4 *) _mat4_rotation_quat((mfloat_t *) result,
					    (const mfloat_t *)q0);
}

mat4 *mat4_translation(mat4 * result, const mat4 * m0, const vec3 * v0)
{
	return (mat4 *) _mat4_translation((mfloat_t *) result,
					  (const mfloat_t *)m0,
					  (const mfloat_t *)v0);
}
...
{
	return (mat4 *) _mat4_scaling((mfloat_t *) result, (mfloat_t *) m0,
				      (mfloat_t *) v0);
}

mat4 *mat4_scale(mat4 * result, mat4 * m0, vec3 * v0)
{
	return (mat4 *) _mat4_scale((mfloat_t *) result, (mfloat_t *) m0,
				    (mfloat_t *) v0);
}
...
{
	return (mat4 *) _mat4_lerp((mfloat_t *) result, (mfloat_t *) m0,
				   (mfloat_t *) m1, f);
}

mat4 *mat4_look_at(mat4 * result, vec3 * position, vec3 * target, vec3 * up)
{
	return (mat4 *) _mat4_look_at((mfloat_t *) result,
				      (mfloat_t *) position,
				      (mfloat_t *) target, (mfloat_t *) up);
}
...
mat4 *mat4_perspective(mat4 * result, mfloat_t fov_y, mfloat_t aspect,
		       mfloat_t n, mfloat_t f)
{
	return (mat4 *) _mat4_perspective((mfloat_t *) result, fov_y, aspect, n,
					  f);
}
...
mat4 *mat4_perspective_fov(mat4 * result, mfloat_t fov, mfloat_t w, mfloat_t h,
			   mfloat_t n, mfloat_t f)
{
	return (mat4 *) _mat4_perspective_fov((mfloat_t *) result, fov, w, h, n,
					      f);
}
...
mat4 *mat4_perspective_infinite(mat4 * result, mfloat_t fov_y, mfloat_t aspect,
				mfloat_t n)
{
	return (mat4 *) _mat4_perspective_infinite((mfloat_t *) result, fov_y,
						   aspect, n);
}
